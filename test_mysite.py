...
class TestMySite():
	...
	def test_TC_AddPro_001(self, set_up):
		...
		btn_img.send_keys('C:\\Users\\VMO-PHUCH\\Downloads\\moon1.jpg')
		time.sleep(1)
		path = self.get_file_name_by_time(settings.CREATE_NEW_PRO_PATH)
		...
		btn_single.click()
		assert self.driver.title == expected
		assert 'Project 4' in self.driver.page_source
